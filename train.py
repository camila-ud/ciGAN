...
class CiGAN:
    ...
    def set_loss_function(self):
        ...
        if self.type =="lsgan":
            ...
            D_loss_real = tf.reduce_mean(tf.nn.l2_loss(self.D_logits_real - tf.ones_like(self.D_logits_real)*0.9)) 
    ...
    def build_model(self,batch_normalization = False):
        ...
        #discriminator
        self.D_real, self.D_logits_real = build_discriminator(self.input_real, self.input_mask)
        self.D_fake, self.D_logits_fake = build_discriminator(self.fake_image, self.input_mask,reuse=True)
